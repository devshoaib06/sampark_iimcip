            ...
            <div class="postCard manage-wrap">
                <div class="postWrap">
                    <div class="pwdbox">
                        ...
                        <form name="frm_pfupd" id="frm_pfupd" action="{{ route('startup.updprof', [$startUpId]) }}"
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="inv-info-box">
                                                                <div class="holder">
                                                                    ...
                                                                    <div class="field-box">
                                                                        <label> Source : </label>
                                                                        <select name="company_source[]" required
                                                                            class="form-control"
                                                                            id="company_source_{{ $i }}">
                                                                            <option value="1"
                                                                                {{ old('company_source', $vv->source ?? '') == 1 ? 'selected' : '' }}>
                                                                                IIMCIP</option>
                                                                            <option value="2"
                                                                                {{ old('company_source', $vv->source ?? '') == 2 ? 'selected' : '' }}>
                                                                                VC</option>
                                                                            <option value="3"
                                                                                {{ old('company_source', $vv->source ?? '') == 3 ? 'selected' : '' }}>
                                                                                Angel</option>
                                                                            <option value="4"
                                                                                {{ old('company_source', $vv->source ?? '') == 4 ? 'selected' : '' }}>
                                                                                Govt & Others</option>
                                                                        </select>
                                                                    </div>
                                                                    <div class="field-box">
                                                                        ...
                                                                        <input type="text" name="company_instrument[]"
                                                                            class="form-control"
                                                                            id="company_instrument_{{ $i }}"
                                                                            placeholder="Instrument"
                                                                            value="@if (!empty($vv->instrument)) {{ $vv->instrument }} @endif">
                                                                    </div>
                                                                    <div class="field-box">
                                                                        <label>Value :</label>
                                                                        <input type="text" name="company_value[]"
                                                                            ...
                                                                            id="company_value_{{ $i }}"
                                                                            placeholder="Value"
                                                                            value="@if (!empty($vv->value)) {{ $vv->value }} @endif">
                                                                    </div>
                                                                    <div class="field-box">
                                                                        ...
                                                                        <input type="text" name="funders_name[]"
                                                                            ...
                                                                            value="@if (!empty($vv->funders_name)) {{ $vv->funders_name }} @endif">
                                                                    </div>
                                                                    <div class="field-box">
                                                                        <label>Year :</label>
                                                                        <input type="text" name="year[]"
                                                                            ...
                                                                            id="year_{{ $i }}"
                                                                            placeholder="Year"
                                                                            value="@if (!empty($vv->year)) {{ $vv->year }} @endif">
                                                                    </div>
                                                                    <div class="field-box">
                                                                        ...
                                                                        <input type="text" name="other_details[]"
                                                                            ...
                                                                            value="@if (!empty($vv->other_details)) {{ $vv->other_details }} @endif">
                                                                    </div>
                                                                </div>
                                                                @if ($i != 1)
                                                                    <a id="rm-answer-{{ $i }}"
                                                                        class="btn btn-danger btn-remove"
                                                                        onClick="remove_invest({{ $i }})">Remove</a>
                                                                @else

                                                                    @if($userType == 4)
                                                                    <a id="ad-contact_person-{{ $i }}"
                                                                        class="btn btn-success btn-add"
                                                                        onClick="clone_invest()">Add More</a>
                                                                        @endif
                                            ...
                                            <div id="invest_sec_1">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <input type="radio" name="is_raised_invest"
                                                            onclick="change_hidden_answer_type_value(1)"
                                                            id="is_raised_invest" value="1"
                                                            @if (isset($user->is_raised_invest)) @if ($user->is_raised_invest == 1) checked @endif
                                                            @endif>Yes
                                                        <input type="radio" name="is_raised_invest" id="is_raised_invest"
                                                            onclick="change_hidden_answer_type_value(0)" value="0"
                                                            @if (isset($user->is_raised_invest)) @if ($user->is_raised_invest == 0) checked @endif
                                                            @endif>No

                                                        <input type="hidden" name="raise_check" id="raise_check"
                                                            value="{{ $user->is_raised_invest }}">
                                                        ...
                                                        <div class="form-group" id="show_raise" style="display: none">
                                                            ...
                                                            {{-- <label> Source : </label>
                                                             <input type="text" name="company_source[]"
                                                                class="form-control" id="company_source_1"
                                                                placeholder="Source"> --}}
                                                        <div class="inv-info-box">
                                                            <div class="holder">
                                                                <div class="field-box">
    ...
    @push('page_js')
        ...
        <script type="text/javascript">
            ...
            function clone_invest() {
                ...
                table_row += '<input type="text" name="funders_name[]" id="funders_name_' + new_id +
                    '" class="form-control"  placeholder="Funders Name"/> ';
                table_row += '</div>';
                ...
                table_row += '<input type="text" name="year[]" id="year_' + new_id +
                ...
                table_row += '<input type="text" name="other_details[]" id="other_details_' + new_id +
