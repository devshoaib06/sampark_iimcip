    ...
    <div class="col-lg-12 fin-report">
        ...
        <table class="table table-bordered">
            <thead>
                <tr>
                    <th>SI#</th>
                    <th>Indirect Employees</th>
                    <th>Employee Count</th>
                    <th>Women Employee Count</th>
            ...
            <tbody>
                @foreach ($impacts as $key => $list)
                    <tr>
                        ...
                        <td>{{ $key + 1 }}</td>
                        <td>{{ $list->indirect_employees }}</td>
                        <td>{{ $list->employee_count }}</td>
                        <td>{{ $list->women_employee_count }}</td>
                        <td>{{ $list->total_beneficiaries }}</td>
                        @if($userType == 4)
                        <td>
                            <a class="btn btn-primary" href="{{ route('startup.impacts.edit', $list->id) }}"><i
