...
<div>
        ...
        <div class="float-end">
            <a href="{{route('startup.addfunding',[$funds->startup_id])}}" class="btn btn-info">
    ...
    {{-- <div class="card card-body bg-light p-4"> --}}
      ...
      <div class="postCard manage-wrap">
        ...
        {{-- <form action="{{ route('incubatee.task.update', $task->id) }}" method="POST"> --}}
             <form action="{{route('startup.needs.update', $funds->id)}}" method="POST">
            {{ csrf_field() }}
            <div class="row">
        ...
        <div class="mt-3">
            <a href="{{route('startup.addfunding',[$funds->startup_id])}}" class="btn btn-secondary mr-2"><i class="fa fa-arrow-left"></i> Cancel</a>
