        ...
        <nav class="navbar navbar-expand-lg pms-nav d-flex justify-content-between">
            ...
            <div class="d-flex align-items-center" id="pmsNavbar">
                ...
                <ul class="navbar-nav flex-row align-items-center ml-lg-5">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('front.user.startup') }}" aria-selected="true"
                            @if (!isset($_GET['category']) && !isset($_GET['industry']) && !isset($_GET['post'])) aria-selected="true" @endif title="Startup">
                            <i class="fa fa-rocket"></i>
                            <span id="pnIndicator" class="pn-ProductNav_Indicator"></span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('front.user.company') }}" aria-selected="true"
                            @if (!isset($_GET['category']) && !isset($_GET['industry']) && !isset($_GET['post'])) aria-selected="true" @endif title="Users">
                            <i class="fas fa-user"></i>
                            <span id="pnIndicator" class="pn-ProductNav_Indicator"></span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('front.user.myMessages') }}" aria-selected="true"
                            @if (!isset($_GET['category']) && !isset($_GET['industry']) && !isset($_GET['post'])) aria-selected="true" @endif title="Messages">
                    ...
                    <li class="nav-item dropdown pro-drop">
                        ...
                        <div class="dropdown-menu border-0 shadow" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="{{ route('incubatee.user.feed') }}" target="_blank">
                                <span><i class="fas fa-laptop"></i></span>Incubation Dashboard
                            </a>
                            ...
                            @if ($user_type == 2)
                                <a class="dropdown-item"
                                    href="{{ route('front.user.addusr', ['timestamp_id' => Auth::user()->timestamp_id]) }}">
                            ...
                            <a class="dropdown-item" href="{{ route('incubatee.user.logout') }}">
