                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" id="notes" name="notes" rows="5">{{ $task->notes }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select name="assigned_by[]" class="form-control assignedIds" multiple="multiple"
                                        redonly disabled>
                                        <option selected value="{{ $task->getUserName->id }}">
                                            {{ $task->getUserName->member_company != '' ? $task->getUserName->member_company : $task->getUserName->contact_name }}
                                        </option>
                                    </select>
                                </div>
                            </div>
