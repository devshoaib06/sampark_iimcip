...
<div>
        ...
        <div class="float-end">
            <a href="{{route('front.user.addimpact')}}" class="btn btn-info">
    ...
    {{-- <div class="card card-body bg-light p-4"> --}}
      ...
      <div class="postCard manage-wrap">
        ...
        <div class="mt-3">
            <a href="{{route('front.user.addimpact')}}" class="btn btn-secondary mr-2"><i class="fa fa-arrow-left"></i> Cancel</a>
