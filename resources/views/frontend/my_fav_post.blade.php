            ...
            <div class="col-sm-12">
                <div class="postCard">
                    <div class="postWrap">
                        ...
                        <div class="postUser">
                            ...
                            <div class="userInfo">
                                <h3>
                                    ...
                                    <a href="{{ route('front.user.memberProfile', array('member_company' => myUrlEncode($memberInfo->member_company))) }}">{{ $memberInfo->contact_name }}</a> 
                                    @endif
						...
						<img src="/public/front_end/images/{{$post->image}}" style="height: 150px; width: 250px;">
