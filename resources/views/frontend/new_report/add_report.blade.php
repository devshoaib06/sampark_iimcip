...
<div class="innercont"> @if(Session::has('flash_message'))
  ...
  <div class="col-sm-12 ">
      ...
      <div class="row">
        <div class="col-lg-12">
         {{ Form::open(array('url' => 'incubate_save_report' , 'method' => 'post' , 'enctype' => 'multipart/form-data','id'=>'report_form')) }}
         ...
         <?php #echo '<pre>'; print_r($data['reportFinancialInformationDetails']); echo '</pre>'; ?>
            <div class="form-group">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td><?php echo date("F'y",strtotime(date("Y-m", strtotime("-3 month")))); ?><input type="hidden" name="date_revenue_3" value="<?php echo date("Y-m-d",strtotime(date("Y-m-d", strtotime("-3 month")))); ?>"></td>
                        <td> 
                    ...
                    <tr>
                        <td><?php echo date("F'y",strtotime(date("Y-m", strtotime("-2 month")))); ?><input type="hidden" name="date_revenue_2" value="<?php echo date("Y-m-d",strtotime(date("Y-m-d", strtotime("-2 month")))); ?>"></td>
                        <td> 
                    ...
                    <tr>
                        <td><?php echo date("F'y",strtotime(date("Y-m", strtotime("-1 month")))); ?><input type="hidden" name="date_revenue_1" value="<?php echo date("Y-m-d",strtotime(date("Y-m-d", strtotime("-1 month")))); ?>"></td>
                        <td> 
                            <?php if(isset($data['prevInformationDetails']['revenue']) && count($data['prevInformationDetails'])) { echo $data['prevInformationDetails']['revenue']+0; ?>
                             <input class="form-control-custom" type="hidden" id="revenue_1" name="revenue_1" value="<?php echo $data['prevInformationDetails']['revenue']; ?>">
                                <?php }else{ ?>
                            <input class="form-control-custom" type="number" id="revenue_1" name="revenue_1" value="">
                            <?php } ?>
                            </td>
                        <td> 
                            ...
                            <input class="form-control-custom" type="hidden" id="expense_1" name="expense_1" value="<?php echo $data['prevInformationDetails']['expense']; ?>">
                                <?php }else{ ?>
                            <input class="form-control-custom" type="number" id="expense_1" name="expense_1" value="">
                            <?php } ?>
                            </td>
                        <td> 
                            ...
                            <input class="form-control-custom" type="hidden" id="burn_rate_1" name="burn_rate_1" value="<?php echo $data['prevInformationDetails']['burn_rate']; ?>">
                                <?php }else{ ?>
                            <input class="form-control-custom" type="number" id="burn_rate_1" name="burn_rate_1" value="">
                            <?php } ?>
                            </td>
                    </tr>
                    ...
                    <tr>
                        <td><?php echo date("F'y",strtotime(date("Y-m", strtotime("+0 month")))); ?><input type="hidden" name="date_revenue_plan_0" value="<?php echo date("Y-m-d",strtotime(date("Y-m-d", strtotime("+0 month")))); ?>"></td>
                        <td><input class="form-control-custom" type="number" id="revenue_plan_0" name="revenue_plan_0" value="<?php echo (isset($data['currentInformationDetails']) && !empty($data['currentInformationDetails'])) ? $data['currentInformationDetails']['revenue']+0 : ''; ?>"></td>
                        <td><input class="form-control-custom" type="number" id="expense_plan_0" name="expense_plan_0" value="<?php echo (isset($data['currentInformationDetails']) && !empty($data['currentInformationDetails'])) ? $data['currentInformationDetails']['expense']+0 : ''; ?>"></td>
                        <td><input class="form-control-custom" type="number" id="burn_rate_plan_0" name="burn_rate_plan_0" value="<?php echo (isset($data['currentInformationDetails']) && !empty($data['currentInformationDetails'])) ? $data['currentInformationDetails']['burn_rate']+0 : ''; ?>"></td>
                    </tr>
                    <tr>
                        <td><?php echo date("F'y",strtotime(date("Y-m", strtotime("+1 month")))); ?><input type="hidden" name="date_revenue_plan_1" value="<?php echo date("Y-m-d",strtotime(date("Y-m-d", strtotime("+1 month")))); ?>"></td>
                        <td><input class="form-control-custom" type="number" id="revenue_plan_1" name="revenue_plan_1" value="<?php echo (isset($data['next_monthInformationDetails']) && !empty($data['next_monthInformationDetails'])) ? $data['next_monthInformationDetails']['revenue']+0 : ''; ?>"></td>
                        <td><input class="form-control-custom" type="number" id="expense_plan_1" name="expense_plan_1" value="<?php echo (isset($data['next_monthInformationDetails']) && !empty($data['next_monthInformationDetails'])) ? $data['next_monthInformationDetails']['expense']+0 : ''; ?>"></td>
                        <td><input class="form-control-custom" type="number" id="burn_rate_plan_1" name="burn_rate_plan_1" value="<?php echo (isset($data['next_monthInformationDetails']) && !empty($data['next_monthInformationDetails'])) ? $data['next_monthInformationDetails']['burn_rate']+0 : ''; ?>"></td>
                    </tr>
                    <tr>
                        <td><?php echo date("F'y",strtotime(date("Y-m", strtotime("+2 month")))); ?><input type="hidden" name="date_revenue_plan_2" value="<?php echo date("Y-m-d",strtotime(date("Y-m-d", strtotime("+2 month")))); ?>"></td>
                        <td><input class="form-control-custom" type="number" id="revenue_plan_2" name="revenue_plan_2" value="<?php echo (isset($data['next_next_monthInformationDetails']) && !empty($data['next_next_monthInformationDetails'])) ? $data['next_next_monthInformationDetails']['revenue']+0 : ''; ?>"></td>
                        <td><input class="form-control-custom" type="number" id="expense_plan_2" name="expense_plan_2" value="<?php echo (isset($data['next_next_monthInformationDetails']) && !empty($data['next_next_monthInformationDetails'])) ? $data['next_next_monthInformationDetails']['expense']+0 : ''; ?>"></td>
                        <td><input class="form-control-custom" type="number" id="burn_rate_plan_2" name="burn_rate_plan_2" value="<?php echo (isset($data['next_next_monthInformationDetails']) && !empty($data['next_next_monthInformationDetails'])) ? $data['next_next_monthInformationDetails']['burn_rate']+0 : ''; ?>"></td>
                    </tr>
