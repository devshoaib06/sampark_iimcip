...
<div class="row">
  ...
  <div class="col-sm-12 ">
      <div class="postWrap my-3 search-alpha1 "><div class="section-title"><strong>Incubate Report</strong></div></div>
      
      <div class="row">
        <div class="col-lg-12">
         <!-- Form::open(array('url' => 'incubate_report_save' , 'method' => 'post' , 'enctype' => 'multipart/form-data','id'=>'report_form')) -->
		<form name="frm" id="frm" action="<?php echo url('incubate_report_save') ?>" method="POST" enctype="multipart/form-data" >
		 {{ csrf_field() }}
			 
            <div class="form-group">
                <label>1) Company Name :</label><?php if(isset($data['startupDetails']->member_company) && !empty($data['startupDetails']->member_company)){ echo $data['startupDetails']->member_company; } ?>
            ...
            <div class="form-group">
                ...
                <table class="table table-bordered">
                    <tr>
                        ...
                        <td colspan='3'><input class="" type="text" name="cash_in_hand" value="<?php  if(isset($data['last_month_info']) && !empty($data['last_month_info'])){ echo $data['last_month_info']['cash_in_hand']+0; }?>"></td>
                    </tr>
                    <tr>
                        <th>Month</th>
                    ...
                    <!--<tr style="display: none">
                        <td><?php echo date("F'y", strtotime(date('Y-m-2')." -3 Month")); ?><input type="hidden" name="date_revenue_3" value="<?php echo date("Y-m-d", strtotime(date('Y-m-2')." -3 Month")); ?>"></td>
                        <td> 
                            ...
                            <?php }else{ ?>
                            <input class="form-control-custom" type="number" id="revenue_3" name="revenue_3" value="">
                            <?php } ?>
                            </td>
                        <td> 
                            <?php if(isset($data['prev_prev_prev_InformationDetails']['expense']) && count($data['prev_prev_prev_InformationDetails'])) {
                                echo $data['prev_prev_prev_InformationDetails']['expense']+0; ?>
                            ...
                            <?php }else{ ?>
                            <input class="form-control-custom" type="number" id="expense_3" name="expense_3" value="">
                            <?php } ?>
                            </td>
                        <td> 
                            <?php if(isset($data['prev_prev_prev_InformationDetails']['burn_rate']) && count($data['prev_prev_prev_InformationDetails'])) { echo $data['prev_prev_prev_InformationDetails']['burn_rate']+0;  ?>
                            ...
                            <?php }else{ ?>
                            <input class="form-control-custom" type="number" id="burn_rate_3" name="burn_rate_3" value="">
                            <?php } ?>
                            </td>
                    </tr>
                    <tr style="display: none">
                        <td><?php echo date("F'y", strtotime(date('Y-m-2')." -2 Month")); ?><input type="hidden" name="date_revenue_2" value="<?php echo date("Y-m-d", strtotime(date('Y-m-2')." -2 Month")); ?>"></td>
                        <td> 
                            <?php if(isset($data['prev_prevInformationDetails']['revenue']) && count($data['prev_prevInformationDetails'])) { echo $data['prev_prevInformationDetails']['revenue']+0; ?>
                            ...
                            <?php } else{ ?>
                            <input class="form-control-custom" type="number" id="revenue_2" name="revenue_2" value="">
                            <?php } ?>
                            </td>
                        <td> 
                            <?php if(isset($data['prev_prevInformationDetails']['expense']) && count($data['prev_prevInformationDetails'])) { echo $data['prev_prevInformationDetails']['expense']+0;  ?>
                            ...
                            <?php }else{ ?>
                            <input class="form-control-custom" type="number" id="expense_2" name="expense_2" value="">
                            <?php } ?>
                            </td>
                        <td> 
                            <?php if(isset($data['prev_prevInformationDetails']['burn_rate']) && count($data['prev_prevInformationDetails'])) { echo $data['prev_prevInformationDetails']['burn_rate']+0;  ?>
                            ...
                            <?php }else{ ?>
                            <input class="form-control-custom" type="number" id="burn_rate_2" name="burn_rate_2" value="">
                            <?php } ?>
                            </td>
                    </tr>-->
                    <tr>
                        <td><?php echo date("F'y", strtotime(date('Y-m-2')." -1 Month")); ?><input type="hidden" name="date_revenue_1" value="<?php echo date("Y-m-d", strtotime(date('Y-m-2')." -1 Month")); ?>"></td>
                        <td> 
                            <?php if(isset($data['prevInformationDetails']['revenue']) && count($data['prevInformationDetails'])) { echo $data['prevInformationDetails']['revenue']+0; ?>
                             <input class="form-control-custom" type="hidden" id="revenue_1" name="revenue_1" step="any" value="<?php echo $data['prevInformationDetails']['revenue']; ?>">
                                <?php }else{ ?>
                            <input class="form-control-custom" type="number" id="revenue_1" name="revenue_1" step="any" value="">
                            <?php } ?>
                            </td>
                        <td> 
                            <?php if(isset($data['prevInformationDetails']['expense']) && count($data['prevInformationDetails'])) { echo $data['prevInformationDetails']['expense']+0; ?>
                            <input class="form-control-custom" type="hidden" id="expense_1" name="expense_1" step="any" value="<?php echo $data['prevInformationDetails']['expense']; ?>">
                                <?php }else{ ?>
                            <input class="form-control-custom" type="number" id="expense_1" name="expense_1" step="any" value="">
                            <?php } ?>
                            </td>
                        <td> 
                            <?php if(isset($data['prevInformationDetails']['burn_rate']) && count($data['prevInformationDetails'])) { echo $data['prevInformationDetails']['burn_rate']+0; ?>
                            <input class="form-control-custom" type="hidden" id="burn_rate_1" name="burn_rate_1" step="any" value="<?php echo $data['prevInformationDetails']['burn_rate']; ?>">
                                <?php }else{ ?>
                            <input class="form-control-custom" type="number" id="burn_rate_1" name="burn_rate_1" step="any" value="">
                            <?php } ?>
                            </td>
                    </tr>
                    ...
                    <tr>
                        <td><?php echo date("F'y", strtotime(date('Y-m-2')." +0 Month")); ?><input type="hidden" name="date_revenue_plan_0" value="<?php echo date("Y-m-d", strtotime(date('Y-m-2')." +0 Month")); ?>"></td>
                        <td><input class="form-control-custom" type="number" id="revenue_plan_0"  name="revenue_plan_0" step="any" value="<?php echo (isset($data['currentInformationDetails']) && !empty($data['currentInformationDetails'])) ? $data['currentInformationDetails']['revenue']+0 : ''; ?>"></td>
                        <td><input class="form-control-custom" type="number" id="expense_plan_0" name="expense_plan_0" step="any" value="<?php echo (isset($data['currentInformationDetails']) && !empty($data['currentInformationDetails'])) ? $data['currentInformationDetails']['expense']+0 : ''; ?>"></td>
                        <td><input class="form-control-custom" type="number" id="burn_rate_plan_0" name="burn_rate_plan_0" step="any" value="<?php echo (isset($data['currentInformationDetails']) && !empty($data['currentInformationDetails'])) ? $data['currentInformationDetails']['burn_rate']+0 : ''; ?>"></td>
                    </tr>
                    <tr>
                        <td><?php echo date("F'y", strtotime(date('Y-m-2')." +1 Month")); ?><input type="hidden" name="date_revenue_plan_1" value="<?php echo date("Y-m-d", strtotime(date('Y-m-2')." +1 Month")); ?>"></td>
                        <td><input class="form-control-custom" type="number" id="revenue_plan_1" name="revenue_plan_1" step="any" value="<?php echo (isset($data['next_monthInformationDetails']) && !empty($data['next_monthInformationDetails'])) ? $data['next_monthInformationDetails']['revenue']+0 : ''; ?>"></td>
                        <td><input class="form-control-custom" type="number" id="expense_plan_1" name="expense_plan_1" step="any" value="<?php echo (isset($data['next_monthInformationDetails']) && !empty($data['next_monthInformationDetails'])) ? $data['next_monthInformationDetails']['expense']+0 : ''; ?>"></td>
                        <td><input class="form-control-custom" type="number" id="burn_rate_plan_1" name="burn_rate_plan_1" step="any" value="<?php echo (isset($data['next_monthInformationDetails']) && !empty($data['next_monthInformationDetails'])) ? $data['next_monthInformationDetails']['burn_rate']+0 : ''; ?>"></td>
                    </tr>
                    <tr>
                        <td><?php echo date("F'y", strtotime(date('Y-m-2')." +2 Month")); ?><input type="hidden" name="date_revenue_plan_2" value="<?php echo date("Y-m-d", strtotime(date('Y-m-2')." +2 Month")); ?>"></td>
                        <td><input class="form-control-custom" type="number" id="revenue_plan_2" name="revenue_plan_2" step="any" value="<?php echo (isset($data['next_next_monthInformationDetails']) && !empty($data['next_next_monthInformationDetails'])) ? $data['next_next_monthInformationDetails']['revenue']+0 : ''; ?>"></td>
                        <td><input class="form-control-custom" type="number" id="expense_plan_2" name="expense_plan_2" step="any" value="<?php echo (isset($data['next_next_monthInformationDetails']) && !empty($data['next_next_monthInformationDetails'])) ? $data['next_next_monthInformationDetails']['expense']+0 : ''; ?>"></td>
                        <td><input class="form-control-custom" type="number" id="burn_rate_plan_2" name="burn_rate_plan_2" step="any" value="<?php echo (isset($data['next_next_monthInformationDetails']) && !empty($data['next_next_monthInformationDetails'])) ? $data['next_next_monthInformationDetails']['burn_rate']+0 : ''; ?>"></td>
                    </tr>
