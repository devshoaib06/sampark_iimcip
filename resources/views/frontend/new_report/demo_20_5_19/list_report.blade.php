      ...
      <div class="row">
        ...
        <div class="col-sm-12">
            ...
            if(count($current_month_info) >0){
                ...
                <span class="rightcsv" style="float:right"><a class="btn btn-default btn-xs m_left10" href="{{ URL::to('incubate_report_add') }}">Add Incubate Report</a></span>
            <?php } ?>
            
            
            <div>
                   {{ Form::model(null, array('URL' => URL::to('incubate_report_list'),'method'=>'post')) }}
