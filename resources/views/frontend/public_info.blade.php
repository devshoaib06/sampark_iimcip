               ...
               <div class="row">
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <div>
                           <select class="form-control " name="company_type" id="company_type" required="required" style="width: 100%;">
               ...
               <div class="row">
                  <div class="col-md-12 col-lg-6">
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="member_company" required="required" value="{{$user->member_company }}" />
                     </div>
                  </div>
                  <div class="col-md-12 col-lg-6">
                     <div class="form-group">
                        <label>Affiliation:</label>
                        <input type="text" class="form-control" name="affiliation" required="required"
                  ...
                  <div class="col-md-12 col-lg-6">
                     <div class="form-group">
                        ...
                        <label>Affiliation Code(SHG Code/DPIIT No.):</label>
                  ...
                  <div class="col-md-12 col-lg-6">
                     <div class="form-group">
                        ...
                        <select class="form-control" name="stage_id" required="required">
                           ...
                           @foreach($stage as $v)
                           <option value="{{ $v->id }}" @if($user->stage_id == $v->id) selected="selected" @endif>{{ $v->stage_name }}</option>
                           @endforeach
                           @endif
                        </select>
                     </div>
                  ...
                  <div class="col-md-12 col-lg-6">
                     <div class="form-group">
                        ...
                        <select class="form-control" name="legal_status"  >
                           ...
                           <option value="{{ $v->id }}" @if($user->legal_status == $v->id) selected="selected" @endif>{{ $v->legal_status }}</option>
                           @endforeach
                           @endif
                        </select>
                     </div>
                  ...
                  <div class="col-md-12 col-lg-6">
                     <div class="form-group">
                        ...
                        <input type="text"   class="form-control" name="incorporation" required="required" value="{{ $user->incorporation }}"  />
                     </div>
                  </div>
                  <div class="col-md-12 col-lg-6">
                     <div class="form-group">
                        <label>Company Email:</label>
                        <input type="email"   class="form-control" name="email_id" required="required" value="{{ $user->email_id }}"  />
                     </div>
                  </div>
                  <div class="col-md-12 col-lg-6">
                     <div class="form-group">
                        <label>Company Phone:</label>
                        <input type="text" class="form-control onlyNumber" name="company_mobile" required="required" value="{{ $user->company_mobile }}" />
                     </div>
                  </div>
                  <div class="col-md-12 col-lg-6">
                     <div class="form-group">
                  ...
                  <div class="col-md-12 col-lg-6">
                     <div class="form-group">
                        <label>Country:</label>
                        <input type="text" class="form-control" name="country" required="required" value="{{ $user->country }}" />
                     </div>
                  </div>
                  <div class="col-md-12 col-lg-6">
                     <div class="form-group">
                        <label>State:</label>
                        <input type="text" class="form-control" name="state" required="required" value="{{ $user->state }}" />
                     </div>
                  </div>
                  <div class="col-md-12 col-lg-6">
                     <div class="form-group">
                        <label>District:</label>
                        <input type="text" class="form-control" name="district" required="required" value="{{ $user->district }}" />
                     </div>
                  </div>
                  <div class="col-md-12 col-lg-6">
                     <div class="form-group">
                        <label>City/Block:</label>
                        <input type="text" class="form-control" name="city" required="required" value="{{ $user->city }}" />
                     </div>
                  </div>
                  <div class="col-md-12 col-lg-6">
                     <div class="form-group">
                  ...
                  <div class="col-md-12 col-lg-6">
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="pincode" required="required" value="{{ $user->pincode }}" />
                     </div>
                  </div>
                  <div class="col-md-12 col-lg-6">
                     <div class="form-group">
                  ...
                  <div class="col-md-12 col-lg-6">
                     <div class="form-group">
                        ...
                        <div class="custom-file">
                           ...
                           <label class="custom-file-label com_logo" for="inputGroupFile01">Choose file</label>
                           @php 
                  ...
                  <div class="col-md-12 col-lg-6">
                     <div class="form-group">
                        ...
                        <div class="custom-file">
                           <input type="file" name="speech" class="custom-file-input file-pitch" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01">
                           <label class="custom-file-label file_pitch_label" for="inputGroupFile01">Choose file</label>
                  ...
                  <div class="col-md-12 col-lg-6">
                     <div class="form-group">
                        <label>&nbsp;</label><br>
                        The allowed files are ppt, pptx, pptm, pps, ppsx, ppsm, pdf, doc, docx and rtf. Max size of file would be 5 Mb
                     </div>
                  </div>
               </div>
               <div class="row mt-3">
                  <div class="col-md-12">
                     ...
                     <textarea name="about_you" id="aboutMe" class="form-control" placeholder="Tell us about yourself" style="height: 150px;">{!! html_entity_decode($user->about_you, ENT_QUOTES) !!}</textarea>
                  </div>
               </div>
               <div class="col-md-12 col-lg-6">
                  <div class="founder-header">
                     ...
                     <div id="video_sec_{{$i}}">
                        <div class="row">
                           <div class="col-md-12">
                              <div class="form-group">
                                 <label>Link : </label>
                                 <input type="text" name="company_video[]" class="form-control" id="company_video_{{$i}}" placeholder="Enter YouTube or Vimeo Video Link" value="@if(!empty($vv->company_video)){{$vv->company_video}}@endif">
                              </div>
                              ...
                              @endphp
                              @if(!empty($thumbnail4))
                              <a onclick ="openVideoModal('{{$vv->company_video}}')"><img src="{{$thumbnail4}}" class="pitch_two"></a>
                              @endif
                              @endif
                           </div>
                           <div class="col-md-12">
                              @if ($i != 1) 
                              <a  id="rm-answer-{{$i}}" class="btn btn-danger btn-remove" onClick="remove_video({{$i}})">Remove</a>
                              @else
                              <a id="ad-contact_person-{{$i}}" class="btn btn-success btn-add" onClick="clone_video()">Add More</a>
                              <input type="hidden" name="answer_row_count" id="answer_row_count" value="{{$c}}" />  
                              @endif
                           </div>
                        </div>
                     ...
                     <div id="video_sec_1">
                        <div class="row">
                           <div class="col-md-12">
                              <div class="form-group">
                                 <label> Link : </label>
                                 <input type="text" name="company_video[]" class="form-control" id="company_video_1" placeholder="Enter YouTube or Vimeo Video Link">
                              </div>
                           </div>
                           <div class="col-md-12">
                              <a id="ad-contact_person-3" class="btn btn-success btn-add" onClick="clone_video()">Add More</a>
                              <input type="hidden" name="answer_row_count" id="answer_row_count" value="1" />        
                           </div>
                           <!-- <div class="col-md-12">
                              <div class="form-group">
                             ...
                             <div class="row">
                                 ...
                                 <div class="col-md-12">
                                     <div class="form-group">
                                         ...
                                         <textarea class="form-control" name="founder_profile[]" id="founder_profile_{{$i}}">@if(!empty($ca->profile)){{$ca->profile}}@endif</textarea>
                                     </div>
                                 </div>
                                 <div class="col-md-12">
                                     <div class="form-group">
                     ...
                     <div id="service_sec" >
                        <div class="col-md-12">
                           <div class="form-group">
                              ...
                              <textarea class="form-control" name="buisness_info" id="buisness_info">@if(!empty($user->buisness_info)){{$user->buisness_info}}@endif</textarea>
                           </div>
                        </div>
                        ...
                        <div id="service_sec_{{$i}}">
                           <div class="row">
                              ...
                              <div class="col-md-4">
                                 <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                       ...
                                       <a class="fancybox" data-fancybox="images" href="{{ $serviceImage}}">
                                       <a class="fancybox" data-fancybox="images" href="{{ $serviceImage}}">
                                       <img src="{{ $serviceImage }}" class="browse-img"></a></a>
                                       @endif
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div class="col-md-4">
                                 <div class="form-group">
                                    <label>Video:</label>
                                    <input type="text" name="buisness_video[]" class="form-control" id="buisness_video_{{$i}}" placeholder="Enter YouTube or Vimeo Video Link" value="@if(!empty($va->buisness_video)){{$va->buisness_video}}@endif">
                                 </div>
                                 ...
                                 @endphp
                                 @if(!empty($thumbnail2))
                                 <a onclick ="openVideoModal('{{$va->buisness_video}}')"><img src="{{$thumbnail2}}" class="pitch_two"></a>
                                 @endif
                                 @endif
                              </div>
                              <!-- <div class="col-md-12">
                              ...
                              <div class="col-md-12">
                                 @if ($i != 1) 
                                 <a  id="rm-answer-{{$i}}" class="btn btn-danger btn-remove" onClick="remove_service({{$i}})">Remove</a>
                                 @else
                                 <a id="ad-contact_person-{{$i}}" class="btn btn-success btn-add" onClick="clone_service()">Add More</a>
                                 <input type="hidden" name="answer_row_count" id="answer_row_count" value="{{$c}}" />  
                                 @endif
                              </div>
                           </div>
                        ...
                        <div id="service_sec_1">
                           <div class="row">
                              ...
                              <div class="col-md-12">
                                 <div class="form-group">
                                    <label>Video : </label>
                                    <input type="text" name="buisness_video[]" class="form-control" id="buisness_video_1" placeholder="Enter YouTube or Vimeo Video Link">
                                 </div>
                              </div>
                              <!-- <div class="col-md-12">
                                 <div class="form-group">
                              ...
                              <div class="col-md-12">
                                 <a id="ad-answer-2" class="btn btn-success btn-add" onClick="clone_service()">Add More</a>
                                 <input type="hidden" name="answer_row_count" id="answer_row_count" value="1" />        
                              </div>
                           </div>
                        </div>
