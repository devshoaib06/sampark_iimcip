        ...
        <div class="postCard">
            <div class="postWrap company-post">
				  @php 
                            ...
                            if(isset($company) && !empty($company) && $company->image != null) {
                                $profileImage = asset('public/uploads/user_images/thumb/'. $company->image);
                            }
						...
						$http_referer_link = str_replace($removeChar, "", $company->linkedIn);
						...
						@endphp
						 ...
						 <div class="row allUser">
                           <div class="col-md-4 col-lg-3 order-1 order-lg-1">
                                ...
                                <a data-toggle="modal" data-target="#userInfo"  onclick="user_details('{{$company->contact_name}}', '{{$company->designation}}',{{$company->id}},'{{ $http_referer_link }}', '{{$profileImage}}','{{$company->member_company}}','{{$company->email_id}}','{{$company->area_of_expertise}}','{{$company->about_you}}')">
							 ...
							 <div class="col-md-12 col-lg-6 order-3 order-lg-2">
                                <div class="alluserInfo">
                                    <h3> 
                                        ...
                                        <a data-toggle="modal" data-target="#userInfo"  onclick="user_details('{{$company->contact_name}}', '{{$company->designation}}',{{$company->id}},'{{ $http_referer_link }}', '{{$profileImage}}','{{$company->member_company}}','{{$company->email_id}}','{{$company->area_of_expertise}}','{{$company->about_you}}')">{{$company->contact_name}}</a> 
                                        @endif
                                    </h3>
                                    <h4>
                                        
                                        
                                        @if($company->designation!=''){{$company->designation}}, @endif{{$company->member_company}}</h4>
                                ...
                                <div class="member-info" style="padding-left: 0; width: 100%;">
                                    <table width="100%" cellpadding="5">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="mailto:{{ $company->email_id }}">{{ $company->email_id }}</a></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><span><a href="//{{ $http_referer_link }}" target="_blank">{{ $company->linkedIn }}</a></span></td>
                                        </tr>
