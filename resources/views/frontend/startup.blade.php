...
<div class="row">
    ...
    @endif
     ...
     {{-- <div class="col-sm-12">
                    <form name="frmx_src" action="{{ route('front.user.startup') }}" method="GET">
                               ...
                               $lettersarray=explode(",",$letters);
                                ...
                                $letters = array();
                                    for ($i = 0; $i < 26; $i++)
                                    {
                                       ...
                                       <a href="{{ route('front.user.startup') }}?searr_id={{ $lettersarray[$i]}}@if(isset($_GET['industry_id']) && $_GET['industry_id'] != '')&industry_id={{ $_GET['industry_id'] }}@endif">{{$lettersarray[$i]}}&nbsp;</a>
                                    ...
                                    <a href="{{ route('front.user.startup') }}@if(isset($_GET['industry_id']) && $_GET['industry_id'] != '')?industry_id={{ $_GET['industry_id'] }}@endif" class="btn btn-primary" style="width:auto;"><b class="text-white"> All</b> </a>
                                    </div>
                                        <br>
                                        <hr class="mt-0">
                                       ...
                                       <option value="{{ route('front.user.startup') }}@if(isset($_GET['searr_id']) && $_GET['searr_id'] != '')?searr_id={{ $_GET['searr_id'] }}@endif">All</option>
                                        ...
                                        <option value="{{ route('front.user.startup') }}?industry_id={{ $v->id}}@if(isset($_GET['searr_id']) && $_GET['searr_id'] != '')&searr_id={{ $_GET['searr_id'] }}@endif" @if(isset($_GET['industry_id']) && $_GET['industry_id']==$v->id) selected="true" @endif onchange="window.open(this.value)" >{{ $v->industry_category }}</option>
										
										
										<option value="{{ route('front.user.startup') }}?industry_id={{ $v->id}}">{{ $v->industry_category }}</option>
                        ...
                        <div class="postUser d-flex">
                            ...
                            <div class="userInfo">
                                <div class="row">
                                    ...
                                    <a href="{{ route('front.user.memberProfile', array('member_company' => $memberInfo->slug)) }}" target="_blank">{{$memberInfo->member_company}}</a> 
                                    @endif
                                    ...
                                    <div class="col-lg-5">
                                        ...
                                        <div class="userReply d-flex justify-end">
                                            <div><p><i class="fa fa-list-alt"></i> <strong class="text-primary">{{$user['number_of_post']}}</strong> Posts</p></div>
                                            <div><p><i class="far fa-comment-alt"></i> <strong class="text-primary">{{$user['number_of_reply']}}</strong> Replies</p></div>
                                        </div>
