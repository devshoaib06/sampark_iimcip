...
@section('content')
            ...
            <tbody>
                @foreach ($compliance as $key => $list)
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-primary" href="{{ route('compliancechecks.edit', $list->id) }}"><i
    ...
    <div class="col-sm-12">
        <div class="postCard manage-wrap">
            <div class="postWrap">
                <div class="pwdbox">
                    <h3>Add Compliance Info</h3>
                    <form name="frm_pfupd" id="frm_pfupd" action="{{ route('front.user.addcomplact') }}" method="post"
