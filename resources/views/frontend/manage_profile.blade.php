   ...
   <div class="postCard manage-wrap">
      <div class="postWrap">
         <div class="pwdbox">
            ...
            <form name="frm_pfupd" id="frm_pfupd" action="{{ route('front.user.updprof') }}" method="post"
                     ...
                     <div class="form-group">
                        ...
                        <div>
                           <select class="form-control indusCatIds" name="industry_category_id[]"
                              id="indusCatIds" multiple="multiple"
                              style="width: 100%;">
               ...
               <div class="row">
                  ...
                  <div class="col-md-12 col-lg-6">
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="company_code" value="{{ $user->company_code }}" />
                     </div>
                  </div>
                  <div class="col-md-12 col-lg-6">
                     <div class="form-group">
                  ...
                  <div class="col-md-12 col-lg-6">
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="incorporation" value="{{ $user->incorporation }}" />
                     </div>
                  </div>
                  <div class="col-md-12 col-lg-6">
                     <div class="form-group">
                        <label>Company Email:</label>
                        <input type="email" class="form-control" name="email_id" value="{{ $user->email_id }}" />
                     </div>
                  </div>
                  <div class="col-md-12 col-lg-6">
                     <div class="form-group">
...
<script type="text/javascript">
   ...
   function clone_service() {
      ...
      // table_row += '<span>*Image size should be less than 2 MB </span>';
       ...
       table_row +=
           ...
           new_id +
           '" aria-describedby="inputGroupFileAddon02"><label class="custom-file-label" for="inputGroupFile02">Choose file</label><span>*Image size should be less than 2 MB </span></div>';
       table_row += '</div>';
       table_row += '</div>';
       table_row += '<div class="col-md-4">';
       table_row += '<div class="form-group">';
