...
<div>
        ...
        <div class="float-end">
            <a href="{{route('front.user.addfinexp')}}" class="btn btn-info">
                <i class="fa fa-arrow-left"></i> All Financial Expense Report
            </a>
        </div>
    ...
    {{-- <div class="card card-body bg-light p-4"> --}}
      ...
      <div class="postCard manage-wrap">
         <div class="postWrap">
            <div class="pwdbox">
             <form action="{{route('financialsexp.update', $finexpense->id)}}" method="POST">
            {{ csrf_field() }}
            <div class="row">
        ...
        <div class="mt-3">
            <a href="{{route('front.user.addfinexp')}}" class="btn btn-secondary mr-2"><i class="fa fa-arrow-left"></i> Cancel</a>
