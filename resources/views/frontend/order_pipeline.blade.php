        ...
        <div class="col-lg-12 fin-report">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class="btn btn-primary" href="{{route('orderpipe.edit',$list->id)}}"><i class="fa fa-edit"></i></a>
    ...
    <div class="col-sm-12">
        <div class="postCard manage-wrap">
            <div class="postWrap">
                <div class="pwdbox">
                    <h3>Add Orders</h3>
                    <form name="frm_pfupd" id="frm_pfupd" action="{{ route('front.user.addorderpipeact') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
