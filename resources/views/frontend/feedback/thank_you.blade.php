...
<head>
    ...
    <style type="text/css">
        ...
        *:after {
        ...
        .postWrap h5 {font-size:30px; font-weight:500; color:#666; text-align:center; padding:60px 60px 0;}
        .postWrap h5 span {color:#2d75a1;}
                    ...
                    <div class="col-lg-12">
                        <div class="postCard" style="margin-top: 40px;">
                            <div class="">
                                ...
                                <h5><span>Thank You For</span><br/> Given Your Feedback.<h5>
