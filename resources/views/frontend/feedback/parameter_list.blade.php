...
<head>
    ...
    <style type="text/css">
        ...
        *:after {
        ...
        .q-top-block-midlist-1 a {color:#333!important;}
        .q-top-block-midlist-1 a:hover {color:#2d75a1!important;}
        .q-top-block-mid2 {
            float: left;
            width: 50%;
            color: #333;
                            ...
                            <div class="">
                                <div class="col-lg-12">
                                    <div class="postWrap">
                                        ...
                                        <div class="q-top-block-list">
                                            <div class="q-top-blocklist-1">All Parameter List<br/>
                                                <small>Click below link to start feedback</small>
                                            </div>

                                            <div class="clearfix"></div>
                                        </div>
                                        <div class="q-top-block-mid-list">

                                            <?php 
                                            $x=0;    
                                            ?>

                                            @forelse ( $allParameters as $key=>$value)

                                            <div class="q-top-block-midlist-1 q-top-block-border">
                                                <a @if (count($value->getResponseBrief)>0)
                                                    href="{{ url('mentor-feedback',$value->id) }}"

                                                    @elseif(count($value->getResponseBrief)==0&&$x==0)
                                                    href="{{ url('mentor-feedback',$value->id) }}"
                                                    <?php
                                                     $x++;
                                                    ?>
                                                    @endif>
                                                    {{ $value->parameter_name }}</a>
                                            </div>
                                            <div class="clearfix"></div>
                                            @empty
                                            <div class="q-top-block-midlist-1 q-top-block-border">No data found.</div>
