...
<div class="row">
    ...
    @endif
            ...
            @foreach($funds as $key => $list)
                ...
                <td>
                      <a class="btn btn-primary" href="{{route('funding.needs.edit',$list->id)}}"><i class="fa fa-edit"></i></a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="funding_requirement" placeholder="Fund Requirement(Rs.)" />
                                </div>
                            </div>
