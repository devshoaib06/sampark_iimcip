...
<div class="row">
    ...
    display: block;">Send Message</a>
           ...
           @endif
			...
			<div class="comp-invest">
			@foreach($company_investments as $company_invest)
			<div class="form-group">
                    <div class="d-flex">
					  
                        <div class="mr-3"><strong>Source: </strong><span>{{ $company_invest->source }}</span></div>
						<div class="mr-3"><strong>Instrument: </strong><span>{{ $company_invest->instrument }}</span></div>
						<div><strong>Value: </strong><span>{{ $company_invest->value }}</span></div>
        ...
        @if(count($company_videos) && empty($company_videos))
