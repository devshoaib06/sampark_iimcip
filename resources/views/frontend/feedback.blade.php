                        ...
                        <div class="postCard" style="margin-top: 40px;">
                                ...
                                <div class="col-lg-12">
                                    <div class="postWrap">
                                        ...
                                        <div class="q-top-block-mid">
                                            <div class="q-top-block-mid1 q-top-block-border">Roadmap</div>
                                            <div class="q-top-block-mid1">4</div>
                                            <div class="q-top-block-mid2">Iterating the roadmap based on success
                                                metrics.</div>
                                            <div class="clearfix"></div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-sm-12">
                                <div class="postCard">
                                    <div class="postWrap">
                                        <div class="postTitle">
                                            <h2 style="margin-bottom:20px;"><i class="fa fa-quora" aria-hidden="true"
                                                    style="color:#2d75a1;"></i>

                                                Do you have a vision and preliminary outline of the roadmap of your
                                                business?</h2>
                                        </div>
                                        <div class="custom-radio-wrap">
                                            <form>
                                                <div class="form-group">
                                                    <input id="html" type="radio" name="custom-radio-btn">
                                                    <label class="custom-radio" for="html"></label>
                                                    <span class="label-text">YES</span>
                                                </div>
                                                <div class="form-group">
                                                    <input id="css" type="radio" name="custom-radio-btn">
                                                    <label class="custom-radio" for="css"></label>
                                                    <span class="label-text">May Be</span>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                    ...
                                    <div class="postWrap">
                                        <div class="postTitle">
                                            <h2 style="margin-bottom:20px;"><i class="fa fa-quora" aria-hidden="true"
                                                ...
                                                Do you have a clear outline of your roadmap and are you beginning to
                                                fill in the details based on the market and how your product addresses
                                                the market need?</h2>
                                        </div>
                                        <div class="custom-radio-wrap">
                                            <form>
                                    ...
                                    <div class="postWrap">
                                        <div class="postTitle">
                                            <h2 style="margin-bottom:20px;"><i class="fa fa-quora" aria-hidden="true"
                                                ...
                                                Do you have a draft detailed roadmap, which includes success metric,
                                                milestones and tasks?</h2>
                                        </div>
                                        <div class="custom-radio-wrap">
                                            <form>
                                                <div class="form-group">
                                    ...
                                    <div class="postWrap">
                                        <div class="postTitle">
                                            <h2 style="margin-bottom:20px;"><i class="fa fa-quora" aria-hidden="true"
                                                ...
                                                Does the team understand your draft detailed roadmap and has started
                                                executing?</h2>
                                        </div>
                                        <div class="custom-radio-wrap">
                                            <form>
                                    ...
                                    <div class="postWrap">
                                        <div class="postTitle">
                                            <h2 style="margin-bottom:20px;"><i class="fa fa-quora" aria-hidden="true"
                                                ...
                                                Do you have a detailed roadmap which you continue to refine based on
                                                your success metrics, channel success and target additional channels?
                                            </h2>
                                        </div>
                                        <div class="custom-radio-wrap">
                                            <form>
                                    ...
                                    <div class="postWrap">
                                        <div class="postTitle">
                                            <h2 style="margin-bottom:20px;"><i class="fa fa-quora" aria-hidden="true"
                                                ...
                                                Do you have a clear, defined roadmap which you are following to scale
                                                the business to success through market dynamics, channels and geographic
                                                expansion?</h2>
                                        </div>
                                        <div class="custom-radio-wrap">
                                            <form>
