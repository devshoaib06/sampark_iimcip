...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    {{ csrf_field() }}
      <div class="form-group has-feedback">
        <input type="email" name="email_id" class="form-control" placeholder="Email" autocomplete="off" value="@if(isset($_COOKIE) && !empty($_COOKIE['vinlec_admin_email'])){{ $_COOKIE['vinlec_admin_email'] }}@endif">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" name="password" class="form-control" placeholder="Password" autocomplete="off" value="@if(isset($_COOKIE) && !empty($_COOKIE['vinlec_admin_password'])){{ $_COOKIE['vinlec_admin_password'] }}@endif">
      ...
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label>
              <input type="checkbox" name="rm_me" value="1" @if(isset($_COOKIE) && !empty($_COOKIE['vinlec_admin_email']) && !empty($_COOKIE['vinlec_admin_password'])) checked="checked" @endif> Remember Me
            </label>
          </div>
        </div>
        <!-- /.col -->
  ...
  <!-- /.login-box-body -->
  <p style="text-align: center; margin-top: 10px;"><span style="font-weight: 600;">{{ $footText }}</span></p>
</div>
