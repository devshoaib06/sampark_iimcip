  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview @if(isset($GparentMenu) && $GparentMenu == 'management') active @endif">
        <a href="#">
          <i class="fa fa-bars" aria-hidden="true"></i> <span>Member Management</span>
          ...
          <li class="treeview @if(isset($parentMenu) && $parentMenu == 'userManagement') active @endif">
            ...
            <ul class="treeview-menu">
              ...
              <li class="@if(isset($childMenu) && $childMenu == 'usersList') active @endif">
                <a href="{{ route('users_list') }}"><i class="fa fa-circle-o"></i> All Member</a>
              </li>
             
              <li class="@if(isset($childMenu) && $childMenu == 'createUser') active @endif">
                <a href="{{ route('crte_user') }}"><i class="fa fa-circle-o"></i> Create Member</a>
              </li>
      ...
      <li class="treeview @if(isset($GparentMenu) && $GparentMenu == 'industryCategory') active @endif">
        <a href="#">
          <i class="fa fa-bars" aria-hidden="true"></i> <span>Industry Category</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
        </a>
        <ul class="treeview-menu">          
          <li class="@if(isset($childMenu) && $childMenu == 'allIndustryCategory') active @endif">
            <a href="{{ route('allIndustryCats') }}"><i class="fa fa-circle-o"></i> All Industry Category</a>
          </li>          
          
          <li class="@if(isset($childMenu) && $childMenu == 'addIndustryCategory') active @endif">
            <a href="{{ route('addIndustryCats') }}"><i class="fa fa-circle-o"></i> Add Industry Category</a>
          </li>          
        </ul>
      </li>

    <li class="treeview @if(isset($GparentMenu) && $GparentMenu == 'memberBusiness') active @endif">
        <a href="#">
          <i class="fa fa-bars" aria-hidden="true"></i> <span>Member Business</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
        </a>
        <ul class="treeview-menu">          
          <li class="@if(isset($childMenu) && $childMenu == 'allmemberBusiness') active @endif">
            <a href="{{ route('contact.all') }}"><i class="fa fa-circle-o"></i> All Member Business</a>
          </li>          
          
          <li class="@if(isset($childMenu) && $childMenu == 'addmemberBusiness') active @endif">
            <a href="{{ route('contact.add') }}"><i class="fa fa-circle-o"></i> Add Member Business</a>
          </li>          
        </ul>
      </li>
