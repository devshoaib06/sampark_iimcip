    ...
    <div class="col-md-12">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Post Guidlines</h3>
          ...
          ?>
        <div class="box-body">
          <form name="frm" id="frmx" action="{{ route('main_post.save_guide') }}" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
          ...
          <div class="row page_block">
            <div class="col-md-10">
              ...
              <div class="form-group">
                <label>Post Guidlines : </label>
                <textarea name="post_information" id="post_information" class="form-control" style="height: 100px;" placeholder="Enter Post Information">@if( isset($data->post_guide) ){{ html_entity_decode($data->post_guide, ENT_QUOTES) }}@endif</textarea>
              </div>
