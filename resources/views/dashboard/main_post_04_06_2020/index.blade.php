        ...
        @if(isset($alldata))
          ...
          <tr>
            ...
            <td>
                ...
                <!-- <a title="Reply" href="{{ route('post_reply.all') }}"><i class="fa fa-reply fa-2x base-blue"></i> </a> -->
                <a title="Reply" data-toggle="modal" data-target="#exampleModalCenter"><i class="fa fa-reply fa-2x base-blue"></i> </a>
