...
<form name="frm" id="frmx" action="@if( isset($fileCat) ){{ route('updCats', array('id' => $fileCat->id)) }}@else{{ route('sveCats') }}@endif" method="post" enctype="multipart/form-data">
{{ csrf_field() }}
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-6">
      <a href="{{ route('allCats') }}" class="btn btn-primary"> All Startup Categories</a>
    </div>
    <div class="col-md-6">
    </div>
  </div>
        ...
        <div class="box-body">
          ...
          <div class="row">
            <div class="col-md-10">
              <div class="form-group">
                ...
                <input type="text" name="category" id="catName" class="form-control" placeholder="Enter Category" value="@if( isset($fileCat) ){{ $fileCat->name }}@endif">
              </div>
            </div>
            <div class="col-md-2">
              <div class="form-group">
          ...
          <div class="row">
            <div class="col-md-2">
              ...
              @else
              <input type="submit" class="btn btn-primary" value="Add Category" style="width:100%;">
              @endif
            </div>
          </div>
        </div>
