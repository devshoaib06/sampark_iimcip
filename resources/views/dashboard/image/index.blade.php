...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-6">
      <a href="{{ route('file_img_add') }}" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Add New Media</a>
    </div>
    <div class="col-md-6">
    </div>
  </div>
    ...
    <!-- <div class="box-header with-border">
      ...
      <div class="row">
        ...
        <div class="col-md-2" style="text-align: right;">
          ...
          <a href="{{ route('file_all_imgs') }}" class="btn btn-danger">Cancel</a>
        </div>
      </div>
      </form>
    </div> -->
    <div class="box-body">
      <form name="frmx4" action="{{ route('file_img_multidel') }}" method="post">
      {{ csrf_field() }}
      <div class="row">
        <div class="col-md-3">
            ...
            @if(isset($allImages))
              ...
              <tr class="x">
                ...
                <td>
                    ...
                    <a href="{{ route('file_img_detl', array('id' => $img->id)) }}"><i class="fa fa-pencil-square-o fa-2x base-green"></i></a>
                  
                 
                    <a href="{{ route('file_img_del', array('id' => $img->id)) }}" onclick="return confirm('Sure To Delete This Image ?');"><i class="fa fa-trash-o fa-2x base-red"></i></a>
                ...
                <td>
                  @if($img->media_type == '1')
                  <img src="{{ asset('public/uploads/files/media_images/'. $img->media_filepath) }}" style="width: 60px;" class="img-thumbnail">
                  @endif
                  @if($img->media_type == '2')
                  <!-- <img src="{{ asset('public/uploads/files/media_images/'. $img->media_filepath) }}" style="width: 60px;" class="img-thumbnail"> -->
                  <video width="260" controls>
                    <source src="{{ asset('public/uploads/files/media_images/'. $img->media_filepath) }}" type="video/mp4">
                  </video>
                  @endif
                </td>
                <td>{{ Auth::user()->contact_name }}</td>
