...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="{{ route('file_all_imgs') }}">All Images</a></li>
    <li>Image Details</li>
  </ol>
</section>
@endsection
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-6">
      <a href="{{ route('file_all_imgs') }}" class="btn btn-primary"> All Images</a>
    </div>
    <div class="col-md-6">
    </div>
  </div>
    ...
    <div class="col-md-12">
      ...
      <div class="box">
        ...
        <div class="box-body">
          ...
          <form name="frm" id="frmx" action="@if( isset($imgInfo) ){{ route('file_img_Upd', array('id' => $imgInfo->id)) }}@else{{ route('file_img_upload') }}@endif" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
