  ...
  <div class="row" style="margin-top: 10px;">
    <div class="col-md-12">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <form name="frm" id="frmx" action="@if(isset($user_data) && !empty($user_data)){{ route('upd_sub_user', array('utid' => $user_data->timestamp_id)) }}@endif" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
           ...
           <div class="row">
            <div class="col-sm-12 col-md-6">
              <div class="form-group">
               ...
               <?php $area=explode(',',$user_data->area_of_expertise);?>
            ...
            <div class="col-sm-12 col-md-6">
              <div class="form-group">
                ...
                <input type="text" name="designation" class="form-control" placeholder="Enter Role/Designation" value="@if(isset($user_data) && !empty($user_data)){{ $user_data->designation }}@endif">
              </div>
            </div>
            ...
            <div class="col-sm-12 col-md-6">
              <div class="form-group">
                <label>Phone : </label>
                <input type="text" name="mobile" class="form-control" placeholder="Enter Phone" value="@if(isset($user_data) && !empty($user_data)){{ $user_data->mobile }}@endif">
              </div>
            </div>
            ...
            <div class="col-sm-12 col-md-6">
              <div class="form-group">
                ...
                <input type="text" name="linkedIn" class="form-control" placeholder="Enter LinkedIn Profile Link" value="@if(isset($user_data) && !empty($user_data)){{ $user_data->linkedIn }}@endif">
              </div>
            </div>
            <!-- <div class="col-md-3">
              <div class="form-group">
