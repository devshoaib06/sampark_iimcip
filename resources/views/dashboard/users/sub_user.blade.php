...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <a href="{{ route('crte_sub_user', array('utid' => $user_id)) }}" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Create Startup User</a>
            ...
            @if(Auth::user()->id == 1)
              <tr>
                <td>
                    ...
                    <a href="{{ route('edit_sub_user', array('utid' => $user->timestamp_id,'id'=>$user_id)) }}" data-toggle="tooltip" data-placement="bottom" title="Edit User"><i class="fa fa-2x fa-pencil-square-o base-green"></i></a>
                  
                    <a href="{{ route('del_sub_usr', array('utid' => $user->timestamp_id)) }}" data-toggle="tooltip" data-placement="bottom" title="Delete User" onclick="return confirm('Are You Sure You Want To Delete This User ?');"><i class="fa fa-2x fa-trash-o base-red"></i></a>
