  ...
  <div class="row" style="margin-top: 10px;">
    <div class="col-md-12">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <form name="frm" id="frmx" action="{{ route('save_portfolio') }}" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" name="pin" class="form-control" placeholder="Enter PIN/Zip Code"  autocomplete="off">
              </div>
            </div>
