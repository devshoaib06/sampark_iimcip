...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-6">
      <a href="{{ route('pm_list') }}" class="btn btn-primary"><i class="fa fa-users" aria-hidden="true"></i> All Portfolio Manager</a>
    </div>
    <div class="col-md-6">
    </div>
  </div>
  <div class="row" style="margin-top: 10px;">
    <div class="col-md-12">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <form name="frm" id="frmx" action="@if(isset($user_data) && !empty($user_data)){{ route('upd_pm', array('uid' => $user_data->id)) }}@endif" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
          <div class="row">
            <div class="col-sm-12 col-md-4">
              <div class="form-group">
                <label>Name : <em>*</em></label>
                <input type="text" name="name" class="form-control" placeholder="Enter Name" value="@if(isset($user_data) && !empty($user_data)){{ $user_data->first_name }}@endif">
              </div>
            </div>
           ...
           <?php //echo '<pre>';print_r($user_data);  die;?>
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="email" name="email_id" class="form-control" placeholder="Enter Email-Id" value="@if(isset($user_data) && !empty($user_data)){{ $user_data->email_id }}@endif" autocomplete="off">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" name="address" class="form-control" placeholder="Enter Address"  autocomplete="off" value="@if(isset($user_data) && !empty($user_data)){{ $user_data->address }}@endif">
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="form-group">
                <label>PIN/Zip Code : <em>*</em></label>
                <input type="text" name="pin" class="form-control" placeholder="Enter PIN/Zip Code"  autocomplete="off" value="@if(isset($user_data) && !empty($user_data)){{ $user_data->zip_code }}@endif">
              </div>
            </div>
