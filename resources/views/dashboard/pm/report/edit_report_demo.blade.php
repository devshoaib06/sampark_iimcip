...
<section class="content">
  ...
  <div class="box" style="margin-top: 10px;">
    <form name="report_form" id="report_form" action="{{ route('admin.update_report') }}" method="post">
    {{ csrf_field() }}
	...
	<div class="row">
        <div class="col-lg-12">
         ...
         <?php #echo '<pre>'; print_r($data['reportFinancialInformationDetails']); echo '</pre>'; ?>
            <div class="form-group">
                ...
                <table class="table table-bordered">
                    ...
                    <!--<tr style="display: none">
                        ...
                        <td> 
                            <?php if(isset($data['prev_prev_prev_InformationDetails']['revenue'])) {
                        ...
                        <td> 
                            <?php if(isset($data['prev_prev_prev_InformationDetails']['expense'])) {
                                if($data['last_month_info']['created_at']==$data['prev_prev_prev_InformationDetails']['created_at']){ ?>
                        ...
                        <td> 
                            <?php if(isset($data['prev_prev_prev_InformationDetails']['burn_rate'])) { 
                                if($data['last_month_info']['created_at']==$data['prev_prev_prev_InformationDetails']['created_at']){ ?>
                    ...
                    <tr style="display: none">
                        ...
                        <td> 
                            <?php if(isset($data['prev_prevInformationDetails']['revenue'])) {
                        ...
                        <td> 
                            <?php if(isset($data['prev_prevInformationDetails']['expense'])) {
                                if($data['last_month_info']['created_at']==$data['prev_prevInformationDetails']['created_at']){ ?>
                        ...
                        <td> 
                            <?php if(isset($data['prev_prevInformationDetails']['burn_rate'])) { 
                                if($data['last_month_info']['created_at']==$data['prev_prevInformationDetails']['created_at']){ ?>
                    ...
                    <tr>
                        ...
                        <td> 
                            <?php if(isset($data['prevInformationDetails']['revenue'])) { 
                        ...
                        <td> 
                            <?php if(isset($data['prevInformationDetails']['expense'])) { 
                                 if($data['last_month_info']['created_at']==$data['prevInformationDetails']['created_at']){ ?>
                        ...
                        <td> 
                            <?php if(isset($data['prevInformationDetails']['burn_rate'])) { 
                                if($data['last_month_info']['created_at']==$data['prevInformationDetails']['created_at']){ ?>
                    ...
                    <tr>
                        ...
                        //echo date("F'y",strtotime(date("Y-m", strtotime("+0 month",strtotime($data['last_month_info']['submit_date']))))); ?>
            ...
            <div class="form-group" >
                <label>3)  Recent Initiative & Achievement :</label>
                <table class="table table-bordered">
                    <tr>
            ...
            <div class="form-group">
                <label>5) How many months of runway they have and how you are planning to continue beyond that if
funding does not happen</label>
            ...
            <div class="form-group">
                <label>8) Date of disbursement of IIMCIP seed fund</label>
                <table class="table table-bordered">
                    <tr>
                        <td>
            ...
            <div class="form-group">
                <label>9) Share transfer status</label>
                <table class="table table-bordered">
                    <tr>
                        <td>
            ...
            <div class="form-group">
                <label>10) No of shares transferred for incubation support</label>
                <table class="table table-bordered">
                    <tr>
                        <td>
            ...
            <div class="form-group">
                <label>11) Additional shares </label>
                <table class="table table-bordered">
                    <tr>
                        <td>
            ...
            <div class="form-group">
                <label>13) IIMCIP comments</label>
                <table class="table table-bordered">
                    <tr>
                        <td>
...
/*        option.red {background-color: #FF0000; font-weight: bold; font-size: 12px;}
        ...
        option.green {background-color: #008000;}*/
            ...
            <div class="form-group">
                <label>15) Investible status </label>
                <table class="table table-bordered">
                    <tr>
                        <td>
            ...
            <div class="form-group">
                <label>16) Suggested type of fund </label>
                <table class="table table-bordered">
                    <tr>
                        <td>
...
<!--<script src="{{asset('public/assets/bootstrap-datepicker/js/bootstrap.min.js')}}"></script> -->       
<script src="{{asset('public/assets/bootstrap-datepicker/js/bootstrap-datepicker.js')}}" charset="UTF-8"></script>  
