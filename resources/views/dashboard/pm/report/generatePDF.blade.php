...
<table widtd="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
        <td><table width="100%" border="1" cellpadding="5" cellspacing="1" bordercolor="#000000">
                ...
                <tr>
                    <td valign="top" ><p style="font-family:Arial, Helvetica, sans-serif; font-size:10pt">Sales Revenue <?php echo financial_year(date('Y')-1); //echo date('Y',strtotime("-1 year", strtotime($data['financial_year']))); echo '-'.date('y',strtotime($data['financial_year'])); ?> </p></td>
    ...
    <tr>
        <td><table width="100%" border="1" cellpadding="5" cellspacing="1" bordercolor="#000000">
                ...
                <tr>
                    ...
                    <td valign="top" colspan="2" ><p style="font-family:Arial, Helvetica, sans-serif; font-size:10pt"><?php echo (isset($data['promoterDetails']) && count($data['promoterDetails'])>0 && !empty($data['promoterDetails']))? $data['promoterDetails']->name:""; ?></p></td>
                </tr>
                <tr>
                    ...
                    <td valign="top" colspan="2" >
                        ...
                        <p style="font-family:Arial, Helvetica, sans-serif; font-size:10pt"><?php echo (isset($data['promoterDetails']) && count($data['promoterDetails'])>0 && !empty($data['promoterDetails']))? nl2br($data['promoterDetails']->keys_rols):""; ?></p>
                        {{--</ol>--}}
                    </td>
                </tr>
            </table>    </td>
