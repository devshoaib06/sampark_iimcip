...
<form name="frm" id="frmx" action="@if( isset($fileCat) ){{ route('updincubatees', array('id' => $fileCat->id)) }}@else{{ route('sveincubatees') }}@endif" method="post" enctype="multipart/form-data">
{{ csrf_field() }}
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-6">
      <a href="{{ route('allincubatees') }}" class="btn btn-primary"> All Incubatees</a>
    </div>
    <div class="col-md-6">
    </div>
  </div>
        ...
        <div class="box-body">
          ...
          <div class="row">
            <div class="col-md-10">
              <div class="form-group">
                <label>Incubatees : <em>*</em></label>
                <input type="text" name="incubatee_name" id="catName" class="form-control" placeholder="Enter Incubatees Name" value="@if( isset($fileCat) ){{ $fileCat->incubatee_name }}@endif">
              </div>
            </div>
            <div class="col-md-2">
              <div class="form-group">
          ...
          <div class="row">
            <div class="col-md-2">
              ...
              @else
              <input type="submit" class="btn btn-primary" value="Add Incubatees" style="width:100%;">
              @endif
            </div>
          </div>
        </div>
