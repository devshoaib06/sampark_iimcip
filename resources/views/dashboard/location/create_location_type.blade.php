...
<form name="frm" id="frmx" action="@if( isset($fileCat) ){{ route('updlocationType', array('id' => $fileCat->id)) }}@else{{ route('svelocationType') }}@endif" method="post" enctype="multipart/form-data">
{{ csrf_field() }}
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-6">
      <a href="{{ route('alllocationType') }}" class="btn btn-primary"> All Location</a>
    </div>
    <div class="col-md-6">
    </div>
  </div>
        ...
        <div class="box-body">
          ...
          <div class="row">
            <div class="col-md-10">
              <div class="form-group">
                ...
                <input type="text" name="sponsor_name" id="catName" class="form-control" placeholder="Enter Location Name" value="@if( isset($fileCat) ){{ $fileCat->name }}@endif">
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-2">
              ...
              @else
              <input type="submit" class="btn btn-primary" value="Add Location" style="width:100%;">
              @endif
            </div>
          </div>
        </div>
