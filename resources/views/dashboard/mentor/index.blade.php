        ...
        @if(isset($userList))
          ...
          @forelse($userList as $user)
            @if(Auth::user()->user_type == 1)
              <tr>
                <td>
                  <a href="{{ route('member_mentor', array('uid' => $user->id)) }}" data-toggle="tooltip" data-placement="bottom" title="Mentoring Company"><i class="fa fa-tag fa-2x"></i></a>
                  
                    <a href="{{ route('edit_mentor', array('uid' => $user->id)) }}" data-toggle="tooltip" data-placement="bottom" title="Edit Mentor"><i class="fa fa-2x fa-pencil-square-o base-green"></i></a>
                  
                    <a href="{{ route('del_mentor', array('id' => $user->id)) }}" data-toggle="tooltip" data-placement="bottom" title="Delete User" onclick="return confirm('Are You Sure You Want To Delete This User ?');"><i class="fa fa-2x fa-trash-o base-red"></i></a>
				 ...
				 <a href="{{ route('add_mentor_invitations', array('uid' => $user->id)) }}" data-toggle="tooltip" data-placement="bottom" title="Add Invitations"><i class="fa fa-2x  fa-envelope base-orange"></i></a>
