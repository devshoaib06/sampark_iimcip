    ...
    <div class="col-md-12">
      ...
      <div class="box">
		  ...
		  {{--<div class="col-sm-12 col-md-4">
            ...
            <div class="col-sm-12 col-md-4">
              <div class="form-group">
                ...
                <input type="text" name="member_company" class="form-control" placeholder="Enter Name">
              </div>
            </div>--}}
			 <div class="col-sm-12 col-md-4">
              <div class="form-group">
			...
			<div class="col-sm-12 col-md-4">
              <div class="form-group">
                ...
                <input type="text" name="preferred_industry" class="form-control" placeholder="Enter Preferred Industry">
              </div>
            </div>
			<div class="col-sm-12 col-md-4">
              <div class="form-group">
                <label>Experience (Years) : <em>*</em></label>
                <input type="text" name="experience_years" class="form-control" placeholder="Enter Experience">
              </div>
            </div>
			<div class="col-sm-12 col-md-4">
              <div class="form-group">
                <label>Functional Expertise : <em>*</em></label>
                <input type="text" name="functional_expertise" class="form-control" placeholder="Enter Functional Expertise">
              </div>
            </div>
			<div class="col-sm-12 col-md-4">
              <div class="form-group">
                <label>Location : <em>*</em></label>
                <input type="text" name="address" class="form-control" placeholder="Enter Location">
              </div>
            </div>
			<div class="col-sm-12 col-md-4">
              <div class="form-group">
                <label>Investment Interests : <em>*</em></label>
                <input type="text" name="investment_interests" class="form-control" placeholder="Enter Investment Interests">
              </div>
            </div>
			<div class="col-sm-12 col-md-4">
              <div class="form-group">
                <label>Startup Stage Preference : <em>*</em></label>
                <input type="text" name="startup_stage_preference" class="form-control" placeholder="Enter Startup Stage Preference">
              </div>
            </div>
          </div>
        ...
        <div class="col-sm-12 col-md-4">
          <div class="form-group">
            <label>Startups Mentored : <em>*</em></label>
              <textarea name="startups_mentored" id="startups_mentored" class="form-control" placeholder="Enter Startups Mentored" autocomplete="off"></textarea>
          </div>
        </div> 
        ...
        <div class="col-sm-12 col-md-4">
              <div class="form-group">
                <label>Startups Mentored : <em>*</em></label>
                <input type="text" name="startups_mentored" class="form-control" placeholder="Enter Startups Mentored">
              </div>
            </div>
        ...
        <div class="col-md-4">
          <div class="form-group">
            <label>Mobile :</label>
            <input type="text" name="contact_no" class="form-control" placeholder="Enter Mobile No."  autocomplete="off">
          </div>
        </div>
      </div>
      <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                <label>Profile Image : </label>
                  ...
                  <img src="/public/front_end/images/no-img.jpg" class="profile-img-thumb">
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label>Brief Profile : <em>*</em></label>
                  <textarea name="profile_info" id="profile_info" class="form-control" placeholder="Enter About Company" autocomplete="off"></textarea>
              </div>
            </div>    
          </div>
          <div class="row">
