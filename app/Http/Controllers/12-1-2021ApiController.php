    ...
    public function startupList(Request $request){
        ...
        if(!empty($user->id)){
            ...
            foreach ($users as $key => $user) {
                ...
                $DataBag[$key]['memberInfo'] = Users::join('stage', 'stage.id', '=', 'users.stage_id')->where('users.id', '=', $company_id)->select('users.member_company','users.image','stage.stage_name','users.id','users.timestamp_id')->get();
